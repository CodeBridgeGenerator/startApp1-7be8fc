const { Inspection } = require("./inspection.class");
const createModel = require("./inspection.model");
const hooks = require("./inspection.hooks");
...
module.exports = function (app) {
  ...
  app.get("/inspectionSchema", function (request, response) {
