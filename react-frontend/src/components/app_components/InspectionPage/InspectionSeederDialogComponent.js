...
import seederData from "./inspection.seeder.json";
...
const InspectionSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(InspectionSeederDialogComponent);
